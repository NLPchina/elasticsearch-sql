...
public class LogFactory {
    ...
    static {
        ...
        tryImplementation("org.apache.log4j.Logger", "org.durid.support.logging.Log4jImpl");
        tryImplementation("java.util.logging.Logger", "org.durid.support.logging.Jdk14LoggingImpl");
        tryImplementation("org.apache.commons.logging.LogFactory",
                          "org.durid.support.logging.JakartaCommonsLoggingImpl");
        tryImplementation("java.lang.Object", "org.durid.support.logging.NoLoggingImpl");
    }
    ...
    public static synchronized void selectLog4JLogging() {
        try {
            ...
            Class implClass = Resources.classForName("org.durid.support.logging.Log4jImpl");
            logConstructor = implClass.getConstructor(new Class[] { Class.class });
        } catch (Throwable t) {
        }
    }
    ...
    public static synchronized void selectJavaLogging() {
        try {
            ...
            Class implClass = Resources.classForName("org.durid.support.logging.Jdk14LoggingImpl");
            logConstructor = implClass.getConstructor(new Class[] { Class.class });
        } catch (Throwable t) {
        }
    }
